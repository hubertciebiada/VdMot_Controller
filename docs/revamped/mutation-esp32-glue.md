...
Result: **99.71 % overall (3785 / 3796 killed), lowest file `src/logger.cpp` 96.10 %, gate passed.**
Measured on commit `c79fecd` (2026-09-26), 6 workers, 30 min.
...
| `src/logger.cpp` | 96.10 % | 142 | 6 | 6 | 21 | 1 | 3 |
| `src/main.cpp` | 100.00 % | 1 | 0 | 0 | 0 | 0 | 0 |
| `src/mqtt_client.cpp` | 99.70 % | 652 | 2 | 9 | 112 | 48 | 0 |
| `src/net.cpp` | 100.00 % | 343 | 0 | 0 | 33 | 10 | 0 |
| `src/ota.cpp` | 100.00 % | 233 | 0 | 4 | 8 | 3 | 0 |
| `src/stm_link.cpp` | 100.00 % | 64 | 0 | 2 | 1 | 10 | 0 |
| `src/stm_service.cpp` | 100.00 % | 55 | 0 | 0 | 6 | 5 | 0 |
| `src/storage.cpp` | 99.57 % | 689 | 3 | 7 | 77 | 84 | 0 |
| `src/web_server.cpp` | 100.00 % | 1448 | 0 | 1 | 107 | 378 | 0 |
| **total** | **99.71 %** | 3756 | 11 | 29 | 372 | 554 | 3 |
...
- `src/storage.cpp:489:44` bool `false` -> `true`
